            ...
            return (
                <svg width="56" height="56" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g fill="none" fillRule="evenodd">
                        ...
                        <path fill="#FFF" fillRule="nonzero" d="M30.343 36v-5.834h5.686v-4.302h-5.686V20h-4.597v5.864H20v4.302h5.746V36z"/>
                    </g>
                </svg>
            )
        case 'plus':
            return (
                <svg width="9" height="9" xmlns="http://www.w3.org/2000/svg">
                    <text transform="translate(-24 -20)" fill="#F2F4FE" fillRule="evenodd" font-family="Jost-Bold, Jost" font-size="14" font-weight="bold">
