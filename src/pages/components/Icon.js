...
const Icon = ({ name }) => {
    ...
    switch (name) {
        ...
        case 'no-suggestions':
            return (
                <svg width="102" height="108" viewBox="0 0 102 108" xmlns="http://www.w3.org/2000/svg">
